...
template<size_t MASK, size_t ITERATIONS, size_t MEM, bool SOFT_AES, bool PREFETCH>
void cryptonight_sepa_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	for (size_t i = 0; i < ITERATIONS/2; i++)
	{
		uint64_t idx0, idx1, idx2, idx3, idx4, idx5, idx6, hi, lo;
		__m128i *ptr0, *ptr1, *ptr2, *ptr3, *ptr4, *ptr5, *ptr6;
...
template<size_t MASK, size_t ITERATIONS, size_t MEM, bool SOFT_AES, bool PREFETCH>
void cryptonight_enna_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	for (size_t i = 0; i < ITERATIONS/2; i++)
	{
		uint64_t idx0, idx1, idx2, idx3, idx4, idx5, idx6, idx7, idx8, hi, lo;
		__m128i *ptr0, *ptr1, *ptr2, *ptr3, *ptr4, *ptr5, *ptr6, *ptr7, *ptr8;
...
void cryptonight_deca_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	for (size_t i = 0; i < ITERATIONS/2; i++)
	{
		uint64_t idx0, idx1, idx2, idx3, idx4, idx5, idx6, idx7, idx8, idx9, hi, lo;
