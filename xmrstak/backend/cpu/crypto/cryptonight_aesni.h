...
void cryptonight_hash(const void* input, size_t len, void* output, cryptonight_ctx* ctx0)
{
	...
	if((ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_ipbc || ALGO == cryptonight_stellite || ALGO == cryptonight_masari || ALGO == cryptonight_bittube2 || ALGO == cryptonight_red) && len < 43)
	{
		memset(output, 0, 32);
		return;
	}
	...
	if(ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_ipbc || ALGO == cryptonight_stellite || ALGO == cryptonight_masari || ALGO == cryptonight_bittube2 || ALGO == cryptonight_red)
	{
...
void cryptonight_double_hash(const void* input, size_t len, void* output, cryptonight_ctx** ctx)
{
	...
	for (size_t i = 0; i < ITERATIONS; i++)
	{
		...
		if (ALGO == cryptonight_monero || ALGO == cryptonight_aeon || ALGO == cryptonight_ipbc || ALGO == cryptonight_bittube2 || ALGO == cryptonight_red) {
			if (ALGO == cryptonight_ipbc || ALGO == cryptonight_bittube2)
