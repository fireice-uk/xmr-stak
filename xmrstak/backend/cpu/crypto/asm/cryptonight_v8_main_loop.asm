...
PUBLIC cryptonight_v8_mainloop_bulldozer_asm
PUBLIC cryptonight_v8_double_mainloop_sandybridge_asm
PUBLIC cryptonight_v8_rwz_mainloop_asm
PUBLIC cryptonight_v8_rwz_double_mainloop_asm
...
ALIGN(64)
cryptonight_v8_mainloop_bulldozer_asm PROC
	INCLUDE cryptonight_v8_main_loop_bulldozer_win64.inc
	ret 0
	mov eax, 3735929054
cryptonight_v8_mainloop_bulldozer_asm ENDP
...
ALIGN(64)
cryptonight_v8_rwz_mainloop_asm PROC
	INCLUDE cryptonight_v8_rwz_main_loop_win64.inc
	ret 0
	mov eax, 3735929054
cryptonight_v8_rwz_mainloop_asm ENDP

ALIGN(64)
cryptonight_v8_rwz_double_mainloop_asm PROC
	INCLUDE cryptonight_v8_rwz_double_main_loop_win64.inc
	ret 0
	mov eax, 3735929054
cryptonight_v8_rwz_double_mainloop_asm ENDP
